...
const ApplyModal = (props) => {
  return (
    <>
      ...
      <button
        className="mx-2 px-4 py-2 bg-[#62b6cb] text-white hover:bg-[#1b4965] rounded-full shadow-sm"
        onClick={() =>
      ...
      <dialog id={`my_modal_${props.id}`} className="modal">
        <div className="modal-box">
          ...
          <div className="flex flex-row justify-center items-center">
            <form method="dialog" className="flex flex-row justify-center items-center">
              <button className="mx-4 px-4 py-2 bg-success rounded-xl shadow-sm flex items-center w-24 justify-center">
                <svg
